...
export default function App() {
  ...
  const [prizes, setPrizes] = useState<Record<number, Prize>>({
    1: { id: 'p1', place: 1, type: '1st', title: 'រង្វាន់ទី ១៖ បំពេញ' },
    2: { id: 'p2', place: 2, type: '2nd', title: 'រង្វាន់ទី ២៖ បំពេញ' },
    3: { id: 'p3', place: 3, type: '3rd', title: 'រង្វាន់ទី ៣៖ បំពេញ' },
  });
  ...
  const [settings, setSettings] = useState<AppSettings>({
    congratulationsText: 'អបអរសាទរអ្នកឈ្នះត្រឹមត្រូវ!',
    spinDuration: 5,
    themeColor: '#EAB308',
